...
sender_address=EQC4il794WSFzmB0EEJjcDtiE9__l-yb4nJzu7Kt_0hA8qDI # sender is the wallet creator, the address of private key in base-file.pk
owner_address=EQAkqfKFKSWsoC90q7mmOdIDJ2ScPlmip-BCLJHTtgLfFEsu # the owner of the vesting wallet
